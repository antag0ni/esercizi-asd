 ...
 *  PRE: nessuna
 */
TBTNode *bst_node_create(TInfo);

/*
 * Distrugge e dealloca un nodo
 * PRE: nessuna
 */
void bst_node_destroy(TBTNode *);
...
TBinaryTree binarytree_search_iter(TBinaryTree, TInfo);

TBinaryTree binarytree_insert_iter(TBinaryTree, TInfo);

TBinaryTree binarytree_delete_iter(TBinaryTree, TInfo);
