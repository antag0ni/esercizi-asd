 ...
 *  PRE: nessuna
 */
TBTNode *TBT_node_create(TInfo_studenti);
 ...
 * PRE: bt e' ordinato
 */
TBTNode *binarytree_search(TBinaryTree, TInfo_studenti);
 ...
 */
TBinaryTree binarytree_insert(TBinaryTree, TInfo_studenti);
 ...
 */
TBinaryTree binarytree_delete(TBinaryTree, TInfo_studenti);
